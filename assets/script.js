$(document).ready(function () {
    ...
    for (i = 0; i < workHours.length; i++) {
        ...
        $(`<textarea class="col-8 note-input" id="input-${i}"></textarea>`)
            ...
            .appendTo(".row");
        $(`<button class="col-2 btn btn-primary saveBtn" id="hour${i}"></button>`)
            .text("save")
            .appendTo(".row");
    }
    ...
    // Determine if each row is past, present, or future (24 hour time-slots).... Need to find a better way
    if (now > 9) {
